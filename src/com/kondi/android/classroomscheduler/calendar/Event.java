...
public class Event implements Cloneable {
    ...
    public static final String[] EVENT_PROJECTION = new String[] {
            ...
            Events.CALENDAR_ID,				//20
            Events.CALENDAR_DISPLAY_NAME,	//21
    ...
    private static final int CALENDAR_ID = 20;
    private static final int CALENDAR_NAME = 21;
    ...
    public int intersects_with=1;
    public int intersect_index=0;
    ...
    private static Event generateEventFromCursor(Cursor cEvents) {
        ...
        e.calendar_id = cEvents.getInt(CALENDAR_ID);
        e.CalendarName = cEvents.getString(CALENDAR_NAME);
    ...
    public final void dump() {
        ...
        Log.e("Cal", "+  calendar_id = " + calendar_id);

        Log.e("Cal", "+  startinmili = " + startMillis);
	...
	public boolean intersects(Event event) {
		if(startMillis<event.getEndMillis() && startMillis>event.getStartMillis())
			return true;
		if(endMillis<event.getEndMillis() && endMillis>event.getStartMillis())
			return true;
		 Log.v(TAG, startMillis+"   " + endMillis +"  "+ event.getStartMillis()+"   " + event.getEndMillis());
		return false;
	}
}
