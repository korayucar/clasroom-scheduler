...
package com.kondi.android.classroomscheduler.calendar;
...
import com.kondi.android.classroomscheduler.calendar.CalendarController.EventType;
import com.kondi.android.classroomscheduler.calendar.CalendarController.ViewType;
...
{
	public static String TAG = "DayView";
	public static boolean DEBUG = true;
	public static boolean DEBUG_SCALING = true;
	public static final String PERIOD_SPACE = ". ";

	public static float mScale = 0; // Used for supporting different screen densities
	public static final long INVALID_EVENT_ID = -1; //This is used for remembering a null event
	// Duration of the allday expansion
	public static final long ANIMATION_DURATION = 400;
	// duration of the more allday event text fade
	public static final long ANIMATION_SECONDARY_DURATION = 200;
	// duration of the scroll to go to a specified time
	public static final int GOTO_SCROLL_DURATION = 200;
	// duration for events' cross-fade animation
	public static final int EVENTS_CROSS_FADE_DURATION = 400;
	...
	public static int MAX_CELL_HEIGHT = 150;
	public static int MIN_Y_SPAN = 100;

	public boolean mOnFlingCalled;
	public boolean mStartingScroll = false;
	...
	public static final String CALENDARS_WHERE = Calendars._ID + "=%d";

	public static final int FROM_NONE = 0;
	public static final int FROM_ABOVE = 1;
	public static final int FROM_BELOW = 2;
	public static final int FROM_LEFT = 4;
	public static final int FROM_RIGHT = 8;
	...
	public static int mHorizontalSnapBackThreshold = 128;

	public final ContinueScroll mContinueScroll = new ContinueScroll();
	...
	public final UpdateCurrentTime mUpdateCurrentTime = new UpdateCurrentTime();
	public int mTodayJulianDay;

	public final Typeface mBold = Typeface.DEFAULT_BOLD;
	public int mFirstJulianDay;
	public int mLoadedFirstJulianDay = -1;
	public int mLastJulianDay;

	public int mMonthLength;
	public int mFirstVisibleDate;
	public int mFirstVisibleDayOfWeek;
	public int[] mEarliestStartHour;    // indexed by the week day offset
	public boolean[] mHasAllDayEvent;   // indexed by the week day offset
	public String mEventCountTemplate;
	public final CharSequence[] mLongPressItems;
	public String mLongPressTitle;
	public Event mClickedEvent;           // The event the user clicked on
	public Event mSavedClickedEvent;
	public static int mOnDownDelay;
	public int mClickedYLocation;
	public long mDownTouchTime;

	public int mEventsAlpha = 255;
	public ObjectAnimator mEventsCrossFadeAnimation;
	...
	public final Runnable mSetClick = new Runnable() {
		@Override
		public void run() {
	...
	public final Runnable mClearClick = new Runnable() {
		@Override
		public void run() {
	...
	public final TodayAnimatorListener mTodayAnimatorListener = new TodayAnimatorListener();
	 ...
	 */
	public long mLastReloadMillis;

	public HashMap<Integer,String> calNames = new HashMap<Integer,String>();
	public ArrayList<Event> mEvents = new ArrayList<Event>();
	public ArrayList<Event> mAllDayEvents = new ArrayList<Event>();
	public ArrayList<Integer> mCalendarIDs = new ArrayList<Integer>();
	public StaticLayout[] mLayouts = null;
	public StaticLayout[] mAllDayLayouts = null;
	public int mSelectionDay;        // Julian day
	public int mSelectionHour;

	boolean mSelectionAllday;

	// Current selection info for accessibility
	public int mSelectionDayForAccessibility;        // Julian day
	public int mSelectionHourForAccessibility;
	public Event mSelectedEventForAccessibility;
	// Last selection info for accessibility
	public int mLastSelectionDayForAccessibility;
	public int mLastSelectionHourForAccessibility;
	public Event mLastSelectedEventForAccessibility;
	...
	public final Rect mDestRect = new Rect();
	public final Rect mSelectionRect = new Rect();
	// This encloses the more allDay events icon
	public final Rect mExpandAllDayRect = new Rect();
	// TODO Clean up paint usage
	public final Paint mPaint = new Paint();
	public final Paint mEventTextPaint = new Paint();
	public final Paint mSelectionPaint = new Paint();
	public float[] mLines;

	public int mFirstDayOfWeek; // First day of the week

	public PopupWindow mPopup;
	public View mPopupView;

	// The number of milliseconds to show the popup window
	public static final int POPUP_DISMISS_DELAY = 3000;
	public final DismissPopup mDismissPopup = new DismissPopup();

	public boolean mRemeasure = true;

	public final EventLoader mEventLoader;
	...
	public static int SINGLE_ALLDAY_HEIGHT = 34;
	/**
	 ...
	 */
	public static float MIN_UNEXPANDED_ALLDAY_EVENT_HEIGHT = 28.0F; // in pixels
	/**
	 * This is how big the unexpanded allday height is allowed to be.
	 * It will get adjusted based on screen size
	 */
	public static int MAX_UNEXPANDED_ALLDAY_HEIGHT =
	 ...
	 */
	public static int MIN_HOURS_HEIGHT = 180;
	public static int ALLDAY_TOP_MARGIN = 1;
	// The largest a single allDay event will become.
	public static int MAX_HEIGHT_OF_ONE_ALLDAY_EVENT = 34;

	public static int HOURS_TOP_MARGIN = 2;
	public static int HOURS_LEFT_MARGIN = 2;
	public static int HOURS_RIGHT_MARGIN = 4;
	public static int HOURS_MARGIN = HOURS_LEFT_MARGIN + HOURS_RIGHT_MARGIN;
	public static int NEW_EVENT_MARGIN = 4;
	public static int NEW_EVENT_WIDTH = 2;
	public static int NEW_EVENT_MAX_LENGTH = 16;

	public static int CURRENT_TIME_LINE_SIDE_BUFFER = 4;
	public static int CURRENT_TIME_LINE_TOP_OFFSET = 2;
	...
	public static final int MORE_EVENTS_MAX_ALPHA = 0x4C;
	public static int DAY_HEADER_ONE_DAY_LEFT_MARGIN = 0;
	public static int DAY_HEADER_ONE_DAY_RIGHT_MARGIN = 5;
	public static int DAY_HEADER_ONE_DAY_BOTTOM_MARGIN = 6;
	public static int DAY_HEADER_RIGHT_MARGIN = 4;
	public static int DAY_HEADER_BOTTOM_MARGIN = 3;
	public static float DAY_HEADER_FONT_SIZE = 14;
	public static float DATE_HEADER_FONT_SIZE = 32;
	public static float NORMAL_FONT_SIZE = 12;
	public static float EVENT_TEXT_FONT_SIZE = 12;
	public static float HOURS_TEXT_SIZE = 12;
	public static float AMPM_TEXT_SIZE = 9;
	public static int MIN_HOURS_WIDTH = 96;
	public static int MIN_CELL_WIDTH_FOR_TEXT = 20;
	public static final int MAX_EVENT_TEXT_LEN = 500;
	// smallest height to draw an event with
	public static float MIN_EVENT_HEIGHT = 24.0F; // in pixels
	public static int CALENDAR_COLOR_SQUARE_SIZE = 10;
	public static int EVENT_RECT_TOP_MARGIN = 1;
	public static int EVENT_RECT_BOTTOM_MARGIN = 0;
	public static int EVENT_RECT_LEFT_MARGIN = 1;
	public static int EVENT_RECT_RIGHT_MARGIN = 0;
	public static int EVENT_RECT_STROKE_WIDTH = 2;
	public static int EVENT_TEXT_TOP_MARGIN = 2;
	public static int EVENT_TEXT_BOTTOM_MARGIN = 2;
	public static int EVENT_TEXT_LEFT_MARGIN = 6;
	public static int EVENT_TEXT_RIGHT_MARGIN = 6;
	public static int ALL_DAY_EVENT_RECT_BOTTOM_MARGIN = 1;
	public static int EVENT_ALL_DAY_TEXT_TOP_MARGIN = EVENT_TEXT_TOP_MARGIN;
	public static int EVENT_ALL_DAY_TEXT_BOTTOM_MARGIN = EVENT_TEXT_BOTTOM_MARGIN;
	public static int EVENT_ALL_DAY_TEXT_LEFT_MARGIN = EVENT_TEXT_LEFT_MARGIN;
	public static int EVENT_ALL_DAY_TEXT_RIGHT_MARGIN = EVENT_TEXT_RIGHT_MARGIN;
	// margins and sizing for the expand allday icon
	public static int EXPAND_ALL_DAY_BOTTOM_MARGIN = 10;
	// sizing for "box +n" in allDay events
	public static int EVENT_SQUARE_WIDTH = 10;
	public static int EVENT_LINE_PADDING = 4;
	public static int NEW_EVENT_HINT_FONT_SIZE = 12;

	public static int mPressedColor;
	public static int mClickedColor;
	public static int mEventTextColor;
	public static int mMoreEventsTextColor;

	public static int mWeek_saturdayColor;
	public static int mWeek_sundayColor;
	public static int mCalendarDateBannerTextColor;
	public static int mCalendarAmPmLabel;
	public static int mCalendarGridAreaSelected;
	public static int mCalendarGridLineInnerHorizontalColor;
	public static int mCalendarGridLineInnerVerticalColor;
	public static int mFutureBgColor;
	public static int mFutureBgColorRes;
	public static int mBgColor;
	public static int mNewEventHintColor;
	public static int mCalendarHourLabelColor;
	public static int mMoreAlldayEventsTextAlpha = MORE_EVENTS_MAX_ALPHA;

	public float mAnimationDistance = 0;
	public int mViewStartX;
	public int mViewStartY;
	public int mMaxViewStartY;
	public int mViewHeight;
	public int mViewWidth;
	public int mGridAreaHeight = -1;
	public static int mCellHeight = 0; // shared among all DayViews
	public static int mMinCellHeight = 32;
	public int mScrollStartY;
	public int mPreviousDirection;
	public static int mScaledPagingTouchSlop = 0;

	/**
	 * Vertical distance or span between the two touch points at the start of a
	 * scaling gesture
	 */
	public float mStartingSpanY = 0;
	/** Height of 1 hour in pixels at the start of a scaling gesture */
	public int mCellHeightBeforeScaleGesture;
	/** The hour at the center two touch points */
	public float mGestureCenterHour = 0;

	public boolean mRecalCenterHour = false;
	 ...
	 */
	public boolean mHandleActionUp = true;

	public int mHoursTextHeight;
	/**
	 * The height of the area used for allday events
	 */
	public int mAlldayHeight;
	/**
	 * The height of the allday event area used during animation
	 */
	public int mAnimateDayHeight = 0;
	/**
	 * The height of an individual allday event during animation
	 */
	public int mAnimateDayEventHeight = (int) MIN_UNEXPANDED_ALLDAY_EVENT_HEIGHT;
	/**
	 * Whether to use the expand or collapse icon.
	 */
	public static boolean mUseExpandIcon = true;
	/**
	...
	public boolean mUpdateToast;
	public Event mSelectedEvent;
	public Event mPrevSelectedEvent;
	public final Rect mPrevBox = new Rect();
	...
	public final DeleteEventHelper mDeleteEventHelper;
	public static int sCounter = 0;

	public final ContextMenuHandler mContextMenuHandler = new ContextMenuHandler();
	 ...
	 */
	public static final int TOUCH_MODE_INITIAL_STATE = 0;
	 ...
	 */
	public static final int TOUCH_MODE_VSCROLL = 0x20;

	/**
	 * Indicates the touch gesture is a horizontal scroll
	 */
	public static final int TOUCH_MODE_HSCROLL = 0x40;

	public int mTouchMode = TOUCH_MODE_INITIAL_STATE;

	/**
	 * The selection modes are HIDDEN, PRESSED, SELECTED, and LONGPRESS.
	 */
	public static final int SELECTION_HIDDEN = 0;
	public static final int SELECTION_PRESSED = 1; // D-pad down but not up yet
	...
	public boolean mAnimateToday = false;
	public int mAnimateTodayAlpha = 0;
	...
	public boolean mCancellingAnimations = false;
	// tracks whether a touch originated in the allday area
	public boolean mTouchStartedInAlldayArea = false;
	...
	public boolean mCallEdgeEffectOnAbsorb;
	public final int OVERFLING_DISTANCE;
	public float mLastVelocity;

	public final ScrollInterpolator mHScrollInterpolator;
	public AccessibilityManager mAccessibilityMgr = null;
	public boolean mIsAccessibilityEnabled = false;
	public boolean mTouchExplorationEnabled = false;
	public final String mCreateNewEventString;
	public final String mNewEventHintString;
	...
	public void initAccessibilityVariables() {
	...
	public void adjustToBeginningOfWeek(Time time) {
	...
	public void remeasure(int width, int height) {
		...
		if(mNumDays==1)
			mFirstCell = DAY_HEADER_HEIGHT + 30 + ALLDAY_TOP_MARGIN;//!!!!!!!!!!!!!!!!!!!!!
	 ...
	 * trackball.
	 */
	public void switchViews(boolean trackBallSelection) {
	...
	public void sendAccessibilityEventAsNeeded(boolean speakEvents) {
		if (!mIsAccessibilityEnabled) {
			return;
		}
	 ...
	 * @param calEvent
	 */
	public void appendEventAccessibilityString(StringBuilder b, Event calEvent) {
	...
	public class GotoBroadcaster implements Animation.AnimationListener {
		...
		public final Time mStart;
		public final Time mEnd;
	...
	public View switchViews(boolean forward, float xOffSet, float width, float velocity) {
	...
	public void adjustHourSelection() {
		if (mSelectionHour < 0) {
			setSelectedHour(0);
	...
	public final Runnable mCancelCallback = new Runnable() {
		public void run() {
			clearCachedEvents();
		}
	};
	...
	/* package */ void reloadEvents() {
		...
		mEventLoader.loadEventsInBackground(mNumDays, events, mFirstJulianDay, new Runnable() {
			...
			public void run() {
				...
				mEvents = events;
				mCalendarIDs = new ArrayList<Integer>();
				...
				for(Event e : mEvents)
				{
					Integer id = e.calendar_id;
					if(mCalendarIDs.indexOf(id)<0){
						mCalendarIDs.add(id); 
					}
					calNames.put(e.calendar_id, e.CalendarName);
				}
				for(int i = 0; i < mEvents.size() ; i++)
				{
					...
					for(int j = 0; j< i ; j++)
					{
						if(!e.allDay &&!mEvents.get(j).allDay&&

								e.calendar_id ==mEvents.get(j).calendar_id &&
								e.intersects(mEvents.get(j)))
						{
							e.intersects_with++;
							e.intersect_index++;
						}
	...
	// all-day area.
	public void drawUpperLeftCorner(Rect r, Canvas canvas, Paint p) {
	...
	public void drawScrollLine(Rect r, Canvas canvas, Paint p) {
	...
	public int computeDayLeftPosition(int day) {
		int effectiveWidth = mViewWidth - mHoursWidth;
		return day * effectiveWidth / mNumDays + mHoursWidth;
	}

	Paint mCallNameTextPaint = new Paint();
	public void drawAllDayHighlights(Rect r, Canvas canvas, Paint p) {
		if (mFutureBgColor != 0) 
		{
		...
		if( mCalendarIDs.size()>0 && mNumDays == 1){

			int cellWidth = mViewWidth - mHoursWidth; 
	        int singlewidth = cellWidth/ mCalendarIDs.size(); 
	        p.setColor(0xdd999999);
	        Log.v("darwing rectangles", "jjj" + mHoursWidth);
		int i = 0; 
		mCallNameTextPaint.setColor(Color.WHITE);
		mCallNameTextPaint.setTextSize(20);
		for (Integer ss  : mCalendarIDs)
		{
			String s = calNames.get(ss);
			Rect t = new   Rect(mHoursWidth+singlewidth*i+2, r.top,mHoursWidth+ (singlewidth*(i+1))-2,  r.top+30);
			canvas.drawRect(t, p);
			canvas.drawText(s, mHoursWidth+singlewidth*i+2 + 5,r.top+ 25, mCallNameTextPaint);
			i++;
		}
		}
	}
	
	public void drawDayHeaderLoop(Rect r, Canvas canvas, Paint p) {
	...
	public void drawAmPm(Canvas canvas, Paint p) {
	...
	public void drawCurrentTimeLine(Rect r, final int day, final int top, Canvas canvas,
			Paint p) {
	...
	public void drawSelectedRect(Rect r, Canvas canvas, Paint p) {
	...
	public void drawHours(Rect r, Canvas canvas, Paint p) {
		setupHourTextPaint(p);
	...
	public void setupHourTextPaint(Paint p) {
	...
	public void drawDayHeader(String dayStr, int day, int cell, Canvas canvas, Paint p) {
	...
	public void drawGridBackground(Rect r, Canvas canvas, Paint p) {
	 ...
	 * @param p
	 */
	public void drawBgColors(Rect r, Canvas canvas, Paint p) {
		int todayIndex = mTodayJulianDay - mFirstJulianDay;
	...
	public int computeMaxStringWidth(int currentMax, String[] strings, Paint p) {
	...
	public void saveSelectionPosition(float left, float top, float right, float bottom) {
	...
	public Rect getCurrentSelectionPosition() {
		Rect box = new Rect();
	...
	public void setupTextRect(Rect r) {
	...
	public void setupAllDayTextRect(Rect r) {
		if (r.bottom <= r.top || r.right <= r.left) {
			r.bottom = r.top;
			r.right = r.left;
			return;
	 ...
	 */
	 ...
	 public void drawAllDayEvents(int firstDay, int numDays, Canvas canvas, Paint p) {
	 ...
	 public void incrementSkipCount(int[] counts, int startIndex, int endIndex) {
	 ...
	 public void computeAllDayNeighbors() {
	 ...
	 public void drawEvents(int date, int dayIndex, int top, Canvas canvas, Paint p) {
		 Paint eventTextPaint = mEventTextPaint;
		 ...
		 for (int i = 0; i < numEvents; i++) {
			 Event event = events.get(i);
			 if (!geometry.computeEventRect(date, left, top, 
					 cellWidth, event,mCalendarIDs.indexOf(event.calendar_id) , mCalendarIDs.size())) {
	 ...
	 public Rect drawEventRect(Event event, Canvas canvas, Paint p, Paint eventTextPaint,
	 ...
	 public final Pattern drawTextSanitizerFilter = Pattern.compile("[\t\n],");
	 ...
	 public String drawTextSanitizer(String string, int maxEventTextLen) {
	 ...
	 //    public void drawEmptyRect(Canvas canvas, Rect r, int color) {
	 //        int linesIndex = 0;
	 ...
	 public void doExpandAllDayClick() {
	 ...
	 public ObjectAnimator getAllDayEventAnimator() {
	 ...
	 public ObjectAnimator getAllDayAnimator() {
	 ...
	 public float getAverageY(MotionEvent me) {
	 ...
	 public boolean initNextView(int deltaX) {
	 ...
	 public static int getEventAccessLevel(Context context, Event e) {
	  ...
	  */
	 public boolean setSelectionFromPosition(int x, final int y, boolean keepOldSelection) {
	 ...
	 public void findSelectedEvent(int x, int y) {
