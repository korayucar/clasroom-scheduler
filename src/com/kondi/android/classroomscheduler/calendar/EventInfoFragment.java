...
import static com.kondi.android.classroomscheduler.calendar.CalendarController.EVENT_EDIT_ON_LAUNCH;
...
import com.kondi.android.classroomscheduler.ColorPickerSwatch.OnColorSelectedListener;
import com.kondi.android.classroomscheduler.DateException;
import com.kondi.android.classroomscheduler.Duration;
import com.kondi.android.classroomscheduler.EventRecurrence;
import com.kondi.android.classroomscheduler.HsvColorComparator;
import com.kondi.android.classroomscheduler.attendance.AttendanceActivity;
import com.kondi.android.classroomscheduler.calendar.CalendarController.EventInfo;
import com.kondi.android.classroomscheduler.calendar.CalendarController.EventType;
import com.kondi.android.classroomscheduler.calendar.CalendarEventModel.Attendee;
import com.kondi.android.classroomscheduler.calendar.CalendarEventModel.ReminderEntry;
import com.kondi.android.classroomscheduler.calendar.alerts.QuickResponseActivity;
import com.kondi.android.classroomscheduler.calendar.event.AttendeesView;
import com.kondi.android.classroomscheduler.calendar.event.EditEventActivity;
import com.kondi.android.classroomscheduler.calendar.event.EditEventHelper;
import com.kondi.android.classroomscheduler.calendar.event.EventColorPickerDialog;
import com.kondi.android.classroomscheduler.calendar.event.EventViewUtils;
...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
    ...
    public EventInfoFragment(Context context, long eventId, long startMillis, long endMillis,
        ...
        mEventId = eventId;
        Log.v(TAG, "event id is "+ mEventId);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	Log.v(TAG, "creating event info fragment");
        if (savedInstanceState != null) {
            mIsDialog = savedInstanceState.getBoolean(BUNDLE_KEY_IS_DIALOG, false);
            mWindowStyle = savedInstanceState.getInt(BUNDLE_KEY_WINDOW_STYLE,
                    DIALOG_WINDOW_STYLE);
        ...
        mAttendanceButton = (Button)mView.findViewById(R.id.attendance_button);
      ...
      //  mLoadingMsgView.setVisibility(View.GONE);
        ...
        b = mView.findViewById(R.id.attendance_button);
        b.setOnClickListener(new OnClickListener() {
    ...
    private void initAttendeesCursor(View view) {
        ...
        if (mAttendeesCursor != null) {
            ...
            if (mAttendeesCursor.moveToFirst()) {
                ...
                do {
                	 Log.v(TAG, "attendee type "+mAttendeesCursor.getInt(ATTENDEES_INDEX_TYPE ));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if(itemId == R.id.info_action_take_attendance)
        {
        	takeAttendance();
        }
    ...
    private void takeAttendance() {
    	...
    	Time time = new Time (eventTimezone);
    	time.set(mEndMillis-1000);
		Log.e("Takking","attendance");
		Intent intent = new Intent(getActivity(), AttendanceActivity.class);	 
		intent.putExtra(AttendanceActivity.START_TIME, time.format3339(false));  
	    intent.putExtra(AttendanceActivity.CALENDAR_ID, mEventOrganizerEmail);
    ...
    private void updateEvent(View view) {
        ...
        String rRule = mEventCursor.getString(EVENT_INDEX_RRULE);
        eventTimezone  = mEventCursor.getString(EVENT_INDEX_EVENT_TIMEZONE);
