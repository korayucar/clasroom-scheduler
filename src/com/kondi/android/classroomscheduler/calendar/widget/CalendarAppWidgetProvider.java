...
package com.kondi.android.classroomscheduler.calendar.widget;
...
import com.kondi.android.classroomscheduler.calendar.EventInfoActivity;
...
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "com.kondi.android.classroomscheduler.calendar.EXTRA_EVENT_IDS";
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://com.kondi.android.classroomscheduler.calendar/time/" + millis));
    ...
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
        ...
        String dataString = "content://com.kondi.android.classroomscheduler.calendar/events";
        if (id != 0) {
