...
import com.kondi.android.classroomscheduler.ColorPickerDialog;
...
public class CalendarColorPickerDialog extends ColorPickerDialog {
    ...
    private class QueryService extends AsyncQueryService {
        ...
        private static final String TAG = "ColorPickerAsyncQueryService";
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
        	...
        	Log.v(TAG, "onquerycomplete on colorpicker " + token);
    ...
    private void startQuery() {
    	...
    	Log.v("CalendarColorPicker", "starting query");
        if (mService != null) {
            showProgressBarView();
