...
import com.kondi.android.classroomscheduler.HorizontalDayView;
import com.kondi.android.classroomscheduler.HorizontalRelativeLayout;
...
public class DayFragment extends Fragment implements CalendarController.EventHandler,
ViewFactory {
    /**
    ...
    public DayFragment(long timeMillis, int numOfDays) {
        ...
        Log.v("selected number of days","jjj");
    ...
    public View makeView() {
    	Log.v(TAG, "making view");
        mTZUpdater.run();
        DayView view = new HorizontalDayView(getActivity(), CalendarController
                .getInstance(getActivity()), mViewSwitcher, mEventLoader, mNumDays);
        view.setId(VIEW_ID);
        view.setLayoutParams(new ViewSwitcher.LayoutParams(
        		LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        view.setSelected(mSelectedDay, false, false);
  mViewSwitcher.getParent().requestLayout();
        return view;
    }
    ...
    private void goTo(Time goToTime, boolean ignoreTime, boolean animateToday) {
        ...
        Log.v(TAG, "going to a specified time");
