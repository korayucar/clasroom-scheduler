...
//        SearchView.OnCloseListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        Log.v(TAG, "creating event info activity");
        ...
        if (icicle != null) {
            ...
            attendeeResponse =                  Attendees.ATTENDEE_STATUS_NONE;
            ...
            if (data != null) {
                try {
                    ...
                    if (size > 2 && "EventTime".equals(pathSegments.get(2))) {
                        ...
                        //dat = content://com.kondi.android.classroomscheduler.calendar/events/[id]/EventTime/[start]/[end]
